  ...
  return (
    <div className="bg-white flex flex-col justify-between min-h-screen">
      <div className="p-6 mx-auto">
        <img src="/src/assets/Logo.svg" alt="Logo" className="sm:mx-auto mb-4 sm:w-[150px]" />
        ...
        <div className="flex flex-row justify-center items-center mt-6">
          <a href="/src/assets/manual.pdf" download>
          ...
          <a href="https://github.com/p-Teal" target="_blank" rel="noreferrer">
            <img src="/src/assets/git.svg" alt="git" className="w-10 hover:cursor-pointer ml-6" />
          </a>
          <a href="https://www.linkedin.com/in/michelribeiro1/" target="_blank" rel="noreferrer">
            <img src="/src/assets/linkedin.svg" alt="linkedin" className="w-10 hover:cursor-pointer ml-6" />
          </a>
        </div>
      </div>
      ...
      <div className="max-w-3xl mx-auto mb-4">
        <img src="/src/assets/animais.png" alt="Animais" />
      </div>
    </div>
  )
}
